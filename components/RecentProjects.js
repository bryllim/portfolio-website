    ...
    <div className="bg-[#F1F1F1] -mt-40 dark:bg-black">
      <div className="max-w-6xl mx-auto">
        <header className="flex flex-col md:flex-row justify-between items-center pt-40 mx-10 md:my-20 lg:my-0">
          <h1 className="text-6xl lg:text-9xl max-w-lg font-bold text-black my-20 -mt-24 sm:mt-auto  dark:text-gray-100 text-center sm:text-left">
            Recent Projects
          </h1>
          <Link href="/projects">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:-mt-8 pb-40">
          ...
          >
            <div className="relative overflow-hidden">
              <img
                src="/projects/atlanteanventures.png"
                alt="portfolio"
                className="transform hover:scale-125 transition duration-2000 ease-out"
              />
              <h1 className="absolute top-10 left-10 text-gray-50 font-bold text-xl bg-black rounded-md px-2">
          ...
          <a
            href="https://researchtitles.bryllim.com/"
            target="_blank"
            className="w-full block col-span-3 sm:col-span-1  object-cover"
          >
            <div className="relative overflow-hidden shadow-2xl">
              <img
                src="/projects/researchtitles.png"
                alt="portfolio"
